document.getElementById("myNav").innerHTML =
    ...
    + "<div class='all'>"
            + "<button onclick='window.location.href = `parcours.html`;' class='box j'>Johan Hullot -</button>"
            ...
            + "<button onclick='window.location.href = `contact.html` ;' class='box h'>Contact et CV</button>"
        + "</div>"
